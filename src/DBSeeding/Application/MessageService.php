...
namespace Barryosull\TestingPain\DBSeeding\Application;
...
{
    public function registerListeners(EventListener $listener)
    {
        $listener->listenTo(StatusChangedEvent::class, fn($event) => $this->handleStatusChangedEvent($event));
    }
